...
namespace FodyTools
{
    ...
    internal sealed class MethodEditContext : IDisposable
    {
    ...
    {
        public static MethodEditContext CreateEditContext(this MethodDefinition methodDefinition)
        {
            return new MethodEditContext(methodDefinition);
        }
