...
public class UnsafeTests
{
    ...
    [Fact]
    public unsafe void WriteBytesIntoInt32()
    {
        int value = 20;
    ...
    [Fact]
    public unsafe void LongIntoCompoundStruct()
    {
    ...
    [Fact]
    public unsafe void ReadWriteDoublePointer()
    {
        int value1 = 10;
        int value2 = 20;
    ...
    [Fact]
    public unsafe void CopyToVoidPtr()
    {
        int value = 10;
        int destination = -1;
    ...
    [Theory]
    [MemberData(nameof(InitBlockData))]
    public unsafe void InitBlockUnmanaged(int numBytes, byte value)
    {
    ...
    [Theory]
    [MemberData(nameof(InitBlockData))]
    public unsafe void InitBlockRefStack(int numBytes, byte value)
    {
        byte* stackPtr = stackalloc byte[numBytes];
    ...
    [Theory]
    [MemberData(nameof(InitBlockData))]
    public unsafe void InitBlockRefUnmanaged(int numBytes, byte value)
    {
        IntPtr allocatedMemory = Marshal.AllocCoTaskMem(numBytes);
        byte* bytePtr = (byte*)allocatedMemory.ToPointer();
    ...
    [Theory]
    [MemberData(nameof(InitBlockData))]
    public unsafe void InitBlockUnalignedStack(int numBytes, byte value)
    {
    ...
    [Theory]
    [MemberData(nameof(InitBlockData))]
    public unsafe void InitBlockUnalignedUnmanaged(int numBytes, byte value)
    {
    ...
    [Theory]
    [MemberData(nameof(InitBlockData))]
    public unsafe void InitBlockUnalignedRefStack(int numBytes, byte value)
    {
        byte* stackPtr = stackalloc byte[numBytes + 1];
        stackPtr += 1; // +1 = make unaligned
    ...
    [Theory]
    [MemberData(nameof(InitBlockData))]
    public unsafe void InitBlockUnalignedRefUnmanaged(int numBytes, byte value)
    {
        IntPtr allocatedMemory = Marshal.AllocCoTaskMem(numBytes + 1);
        byte* bytePtr = (byte*)allocatedMemory.ToPointer() + 1; // +1 = make unaligned
    ...
    public unsafe void CopyBlock(int numBytes)
    {
    ...
    [Theory]
    [MemberData(nameof(CopyBlockData))]
    public unsafe void CopyBlockRef(int numBytes)
    {
        byte* source = stackalloc byte[numBytes];
        byte* destination = stackalloc byte[numBytes];
    ...
    [Theory]
    [MemberData(nameof(CopyBlockData))]
    public unsafe void CopyBlockUnaligned(int numBytes)
    {
    ...
    [Theory]
    [MemberData(nameof(CopyBlockData))]
    public unsafe void CopyBlockUnalignedRef(int numBytes)
    {
        byte* source = stackalloc byte[numBytes + 1];
        byte* destination = stackalloc byte[numBytes + 1];
        source += 1;      // +1 = make unaligned
    ...
    [Fact]
    public void ByteOffsetStackByte4()
    {
        var byte4 = new Byte4();
    ...
    public void RefAddNuintByteOffset()
    {
        ...
        ref byte r2 = ref Unsafe.AddByteOffset(ref r1, 2);
        Assert.Equal(0x78, r2);
    }
    ...
    [Fact]
    public unsafe void RefIsAddressGreaterThan()
    {
        int[] a = new int[2];
    ...
    [Fact]
    public unsafe void RefIsAddressLessThan()
    {
        int[] a = new int[2];
    ...
    [Fact]
    public unsafe void ReadUnaligned_Ptr_Int32()
    {
        byte[] unaligned = Int32Double.Unaligned(123456789, 3.42);
    ...
    [Fact]
    public unsafe void ReadUnaligned_Ptr_Double()
    {
        byte[] unaligned = Int32Double.Unaligned(123456789, 3.42);
    ...
    [Fact]
    public unsafe void ReadUnaligned_Ptr_Struct()
    {
        byte[] unaligned = Int32Double.Unaligned(123456789, 3.42);
    ...
    [Fact]
    public unsafe void WriteUnaligned_ByRef_Int32()
    {
    ...
    [Fact]
    public unsafe void WriteUnaligned_ByRef_Double()
    {
        byte[] unaligned = new byte[sizeof(Int32Double) + 1];
    ...
    [Fact]
    public unsafe void WriteUnaligned_ByRef_Struct()
    {
        byte[] unaligned = new byte[sizeof(Int32Double) + 1];
    ...
    [Fact]
    public unsafe void WriteUnaligned_Ptr_Int32()
    {
        byte[] unaligned = new byte[sizeof(Int32Double) + 1];
    ...
    [Fact]
    public unsafe void WriteUnaligned_Ptr_Double()
    {
        byte[] unaligned = new byte[sizeof(Int32Double) + 1];
    ...
    [Fact]
    public unsafe void WriteUnaligned_Ptr_Struct()
    {
        byte[] unaligned = new byte[sizeof(Int32Double) + 1];
    ...
    [Fact]
    public void Unbox_CustomValueType()
    {
    ...
    [Fact]
    public void SkipInit_PreservesPrevious()
    {
        ...
        Assert.Equal(21, int32DoubleValue.Int32);
        Assert.Equal(22, int32DoubleValue.Double);
        ...
        Assert.Equal(24, stringInt32Value.Int32);
    ...
    [Fact]
    public unsafe void IsNullRef_NotNull()
    {
        ...
        Assert.False(Unsafe.IsNullRef(ref objectValue));

        string stringValue = nameof(IsNullRef_NotNull);
        Assert.False(Unsafe.IsNullRef(ref stringValue));
    ...
    [Fact]
    public unsafe void IsNullRef_Null()
    {
        // Validate that calling with a primitive type works.
        ...
        Assert.True(Unsafe.IsNullRef(ref Unsafe.AsRef<object>(null)));
        Assert.True(Unsafe.IsNullRef(ref Unsafe.AsRef<string>(null)));
    ...
    public unsafe void NullRef()
    {
        ...
        Assert.True(Unsafe.IsNullRef(ref Unsafe.NullRef<object>()));
        Assert.True(Unsafe.IsNullRef(ref Unsafe.NullRef<string>()));
...
public unsafe struct Int32Double
{
    ...
    public static byte[] Unaligned(int i, double d)
    {
    ...
    public static Int32Double Aligned(byte[] unaligned)
    {
